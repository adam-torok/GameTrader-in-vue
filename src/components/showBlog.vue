<template>
  ...
  <button type="submit" class="absolute right-0 top-0 mt-3 mr-4">
    ...
    <div v-for="blog in filteredBlogs" v-bind:key="blog.id" class="single-blog">
     ...
     <button class="bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md px-2 py-1 inline-flex items-center">
     <i class="far fa-heart"></i>
    </button>    
    
    <button class="bg-white text-gray-800 ml-2 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md px-2 py-1 inline-flex items-center">
...
<script>
import psGames from '../../static/xboxgames.json';
export default{
  data(){
    return{
      psGames,
  ...
  computed:{  
    filteredBlogs:function(){
      return this.psGames.filter((blog) =>{
